...
| 文档版本 | v0.4.4（承 v0.4.3；本版修订：**L1 降级为软边界**——6/16 全项目评审实证 L1 tools 白名单在 agent body > ~40 行时不生效，dm-seek 全部 7 agent body 均超此阈值；三道防线诚实声明同步修订（§6.2 / §6.4 / §9 / §10.1 / §11.1 / §11.4 / 附录A / 附录B） |
| 日期 | 2026-06-17 |
| 负责人 | architect |
